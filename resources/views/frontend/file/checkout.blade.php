...
@section('content')
    ...
    $total = Cart::subtotal();
    ?>
    <form class="form-horizontal form-payment " action="{{ url('/customer/order-store') }}" method="post">
        @csrf
                                    ...
                                    <div id="payment-new" style="display: block">
                                        <div class="form-group required">
                                            <input type="text" name="name" required placeholder="Name *"
                                                class="form-control" value="{{ Auth::guard('customers')->user()->name }}">
                                            @error('name')
                                        ...
                                        <div class="form-group company-input">
                                            <input type="tel" name="phone" required placeholder="Phone *"
                                                class="form-control" value="{{ Auth::guard('customers')->user()->phone }}">
                                            @error('phone')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
