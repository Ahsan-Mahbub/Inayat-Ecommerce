                ...
                <div class="block block-rounded shadow-none mb-0">
                    ...
                    <div class="block-content fs-sm">
                        <form action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-12">Artical </label>
                                <div class="col-lg-12">
                                    <textarea class="form-control form-control-lg editor" id="mega-bio" name="article"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12">Article Title</label>
                                <div class="col-lg-12">
                    ...
                    <div class="block-content fs-sm">
                        <form action="{{ route('category.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-12">Artical </label>
                                <div class="col-lg-12">
                                    <textarea class="form-control form-control-lg editor" id="article" name="article"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12">Image <span class="text-danger">*</span></label>
        ...
        $(document).on("click", "#editcategory", function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#article_title").val(response.article_title);
                    $('#article').summernote('code', response.article);
