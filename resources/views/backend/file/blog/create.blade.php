        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <div class="block-options">
                    <a href="{{ route('blog.index') }}" class="btn btn-alt-primary"><i class="fa fa-list"></i> Blog
                        List</a>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-lg-12">
                                        <input type='text' class="form-control" required name="blog_name"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea class="form-control" required name="short_details"
