        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <button type="button" class="btn btn-alt-primary" data-bs-toggle="modal" data-bs-target="#add_modal"><i
                        class="fa fa-plus"></i> Add Slider</button>
            </div>
                        ...
                        @foreach ($all_slider as $slider)
                            <tr>
                                ...
                                <td class="text-center"><img style="width: auto; height: 50px;"
                                        src="{{ $slider->image ? '/' . $slider->image : '/demo.svg' }}"></td>
                                    ...
                                    <div class="btn-group">
                                        <form action="{{ route('slider.destroy', $slider->id) }}" method="post"
                                            ...
                                            <a href="{{ route('slider.status', $slider->id) }}"
                                                class="btn btn-sm  {{ $slider->status == 1 ? 'btn-success' : 'btn-danger' }} mb-2 js-bs-tooltip-enabled">
                                                <i class="fa fa-refresh"></i>
                                            </a>

                                            <a data-bs-toggle="modal" data-bs-target="#edit_modal" id="editslider"
                                                data="{{ $slider->id }}"
                ...
                <div class="block block-rounded shadow-none mb-0">
                    ...
                    <div class="block-content fs-sm">
                        <form action="{{ route('slider.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-12">Slider Image (1920 × 990) <span class="text-danger">*</span></label>
                                <div class="col-lg-12">
                        ...
                        <form action="{{ route('slider.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <img id="blah2" src="" class="slider_image pt-2" height="200"
                                        width="auto" alt="slider" /><br>
                                </div>
                            </div>
                            <div class="form-group text-center mt-4 mb-4">
